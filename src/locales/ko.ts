...
export const ko: PartialTranslationKeys = {
  ...
  aboutPage: {
    pageTitle: '소개',
    heroDescription: '중국 청소년 스키 포인트 랭킹 공식 플랫폼은 공식 표준에 기반한 종합 경기 관리 플랫폼으로, 중국 스키 경기에 권위 있고 정확한 데이터 관리 및 포인트 계산 서비스를 제공합니다',

    platformTitle: '플랫폼 소개',
    platformDescription1: '중국 국가체육총국 동계스포츠관리센터 공식 발표에 따르면, 베이징 화티빙쉐산업발전유한공사("화티빙쉐")가 2025-2028 3시즌 전국 스노보드 슬로프스타일&빅에어 청소년 U시리즈, 스노보드 패러렐 청소년 U시리즈, 프리스타일 스키 슬로프스타일&빅에어 청소년 U시리즈, 알파인 스키 청소년 U시리즈 대회의 공식 주최자가 되었습니다.',
    platformDescription2: '화티빙쉐의 승인을 받아 본 플랫폼은 경기 포인트 플랫폼의 지정 운영자로서 경기 데이터 수집, 포인트 계산 및 랭킹 발표를 담당합니다. 본 플랫폼은 전국 청소년 스키 U시리즈 경기 포인트 랭킹의 지정 공식 발표 플랫폼으로, 선수, 코치 및 관계자에게 권위 있고 공정하며 시의적절한 경기 정보 서비스를 제공하는 것을 목표로 합니다.',
    platformDescription3: '우리는 중국 스키 스포츠의 디지털화와 표준화를 추진하고, 선수, 코치, 이벤트 주최자, 경기 심판에게 현대적인 데이터 관리, 포인트 계산, 성적 통계 도구를 제공하며, 빅에어, 슬로프스타일, 패러렐 종목 등 설상 경기를 포괄적으로 커버하여 중국 스키의 조직 수준과 경기 수준 향상에 기여합니다.',
