...
export const ja: PartialTranslationKeys = {
  ...
  aboutPage: {
    pageTitle: '概要',
    heroDescription: '中国ユーススキーポイントランキング公式プラットフォームは、公式基準に基づく総合競技管理プラットフォームであり、中国スキー競技に権威ある正確なデータ管理とポイント計算サービスを提供します',

    platformTitle: 'プラットフォーム紹介',
    platformDescription1: '中国国家体育総局冬季スポーツ管理センターの公式発表によると、北京華体氷雪産業発展有限公司（以下「華体氷雪」）が2025-2028年の3シーズンにわたる全国スノーボードスロープスタイル&ビッグエアユースUシリーズ、スノーボードパラレルユースUシリーズ、フリースタイルスキースロープスタイル&ビッグエアユースUシリーズ、アルペンスキーユースUシリーズ大会の公式主催者となりました。',
    platformDescription2: '華体氷雪の認可を受け、本プラットフォームは競技ポイントプラットフォームの指定運営者として、競技データの収集、ポイント計算、ランキング発表を担当しています。本プラットフォームは全国ユーススキーUシリーズ競技ポイントランキングの指定公式発表プラットフォームであり、選手、コーチ、関係者に権威ある公正でタイムリーな競技情報サービスを提供することを目指しています。',
    platformDescription3: '私たちは中国スキースポーツのデジタル化と標準化を推進し、選手、コーチ、イベント主催者、競技審判員に現代的なデータ管理、ポイント計算、成績統計ツールを提供し、ビッグエア、スロープスタイル、パラレル種目などの雪上競技を包括的にカバーし、中国スキーの組織レベルと競技レベルの向上に貢献しています。',
