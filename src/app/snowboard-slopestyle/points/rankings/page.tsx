...
function getSnowboardSlopestyleRankings(
  discipline: string,
  ageGroup: string,
  gender: string
): RankingGroup[] {
...
export default function SnowboardSlopestyleRankingsPage() {
  ...
  const rankingGroups = useMemo(
    () => getSnowboardSlopestyleRankings(selectedDiscipline, selectedAgeGroup, selectedGender),
    ...
    <div className="min-h-screen bg-gray-50">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="text-center mb-8">
          ...
          <h1 className="text-3xl font-bold text-gray-900 mb-2">单板坡障/大跳台积分排名</h1>
          <p className="text-gray-600">Snowboard Slopestyle & Big Air Rankings</p>
        </div>
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-6">
          ...
          <div className="bg-white rounded-lg p-4 shadow-sm border border-purple-100">
            <div className="text-2xl font-bold text-purple-600">{filterOptions.disciplines.length}</div>
            <div className="text-sm text-gray-600">项目数量</div>
          </div>
          <div className="bg-white rounded-lg p-4 shadow-sm border border-purple-100">
            <div className="text-2xl font-bold text-purple-600">{filterOptions.ageGroups.length}</div>
