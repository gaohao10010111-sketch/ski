...
export const metadata = {
  title: '单板坡面障碍技巧',
  description: '单板坡面障碍技巧项目积分管理、赛事管理、运动员管理系统'
};
  ...
  const features = [
    {
      ...
      icon: Calculator,
      href: '/snowboard-slopestyle/points/calculator',
    ...
    },
    {
      ...
      icon: TrendingUp,
      href: '/snowboard-slopestyle/points/rankings',
    ...
    },
    {
      ...
      icon: Calendar,
      href: '/snowboard-slopestyle/events/schedule',
    ...
    },
    {
      ...
      icon: Trophy,
      href: '/snowboard-slopestyle/events/register',
    ...
    },
    {
      ...
      icon: Users,
      href: '/snowboard-slopestyle/athletes/list',
    ...
    },
    {
      ...
      icon: FileText,
      href: '/snowboard-slopestyle/docs/points-rules',
      color: 'bg-cyan-50 text-cyan-600'
    }
  ];

  return (
    <div className="bg-gradient-to-br from-purple-50 to-pink-50 min-h-[calc(100vh-12rem)]">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-600 max-w-3xl mx-auto">
            基于国际标准的单板坡面障碍技巧积分管理系统
          </p>
          <p className="text-sm text-gray-500 mt-2">
            支持Big Air、Slopestyle等单板自由式项目的积分计算与管理
          </p>
        </div>
          ...
          {features.map((feature) => {
            ...
            return (
              <Link
                key={feature.href}
                href={feature.href}
                className="bg-white rounded-xl p-6 shadow-sm hover:shadow-md transition-all duration-200 border border-gray-100 hover:border-purple-200 group"
              >
