...
import { Trophy, Medal, Award, Crown, Download, Search, ArrowLeft, Snowflake } from 'lucide-react'
...
function getSnowboardParallelRankings(
  discipline: string,
  ageGroup: string,
  gender: string
): RankingGroup[] {
...
export default function SnowboardParallelRankingsPage() {
  ...
  const rankingGroups = useMemo(
    () => getSnowboardParallelRankings(selectedDiscipline, selectedAgeGroup, selectedGender),
    ...
    <div className="min-h-screen bg-gray-50">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="text-center mb-8">
          <div className="inline-flex items-center justify-center w-16 h-16 bg-gradient-to-br from-indigo-500 to-indigo-700 rounded-full mb-4 shadow-lg">
            <Snowflake className="w-8 h-8 text-white" />
          </div>
          <h1 className="text-3xl font-bold text-gray-900 mb-2">单板平行项目积分排名</h1>
          <p className="text-gray-600">Snowboard Parallel Rankings (PGS/PSL)</p>
        </div>
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-6">
          ...
          <div className="bg-white rounded-lg p-4 shadow-sm border border-indigo-100">
            <div className="text-2xl font-bold text-indigo-600">{totalAthletes}</div>
            <div className="text-sm text-gray-600">参赛人次</div>
          </div>
          <div className="bg-white rounded-lg p-4 shadow-sm border border-indigo-100">
            <div className="text-2xl font-bold text-indigo-600">{filterOptions.disciplines.length}</div>
            <div className="text-sm text-gray-600">项目数量</div>
          </div>
          <div className="bg-white rounded-lg p-4 shadow-sm border border-indigo-100">
            <div className="text-2xl font-bold text-indigo-600">{filterOptions.ageGroups.length}</div>
